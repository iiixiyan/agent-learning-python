...
![LLM + Tools 架构](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/0_公众号_Yi昭.png)
...
**参考截图（原文 JavaScript 版，逻辑与 Python 版一致）：**

![调用大模型代码1](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/1_公众号_Yi昭.jpeg)

![调用大模型代码2](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/2_公众号_Yi昭.png)

![调用大模型代码3](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/3_公众号_Yi昭.png)

![调用大模型代码4](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/4_公众号_Yi昭.png)

![调用大模型代码5](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/5_公众号_Yi昭.png)
...
![Tool开发截图1](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/6_公众号_Yi昭.png)

![Tool开发截图2](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/7_公众号_Yi昭.png)

![Tool开发截图3](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/8_公众号_Yi昭.png)

![Tool开发截图4](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/9_公众号_Yi昭.png)

![tool_calls输出](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/10_公众号_Yi昭.png)

![Tool运行结果1](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/11_公众号_Yi昭.png)

![Tool运行结果2](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/12_公众号_Yi昭.png)

![Tool运行结果3](../IMG/2025-12-22_从Tool开始：让大模型自动调工具读文件/13_公众号_Yi昭.png)
